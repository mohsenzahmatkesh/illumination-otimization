...
try:
    while True:
        ...
        pwm.set_pwm(channel=7, on_time=0, off_time=int(410))
        pwm.set_pwm(channel=8, on_time=0, off_time=int(410))
        pwm.set_pwm(channel=9, on_time=0, off_time=int(410))
        pwm.set_pwm(channel=10, on_time=0, off_time=int(410))
